    ...
    <div className="w-full flex flex-col items-center justify-center p-3 sm:p-5 bg-white dark:bg-gray-800/80 rounded-2xl border border-gray-200/80 dark:border-gray-700/70 shadow-sm animate-fadeIn">
      ...
      <div className="w-full max-w-[768px] flex items-center justify-between gap-3 pb-3 mb-4 border-b border-gray-100 dark:border-gray-700/60">
        ...
        {onClose && (
          <button
            onClick={onClose}
            className="text-xs font-semibold px-3 py-1.5 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors flex items-center gap-1 cursor-pointer shadow-2xs"
            title="Recolher visualização"
          >
            <span>Recolher</span>
            <svg
      ...
      {/* Frame oficial do Sofascore */}
      <div
        className="w-full flex flex-col items-center justify-center overflow-hidden rounded-xl bg-white dark:bg-gray-900 shadow-2xs border border-gray-100 dark:border-gray-800"
      ...
      >
        ...
        />
        <div className="w-full p-2 text-left text-[11px] font-sans text-gray-400 dark:text-gray-500 bg-gray-50/50 dark:bg-gray-900/50 border-t border-gray-100 dark:border-gray-800">
