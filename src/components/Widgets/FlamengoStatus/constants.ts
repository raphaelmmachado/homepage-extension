import type { NextMatch, Championship, MatchSummary, TournamentBracket } from "./types";
...
export const DEFAULT_LIBERTADORES_BRACKET: TournamentBracket = {
  rounds: [
    {
      ...
      matches: [
        {
          ...
          homeTeam: "Ind. del Valle",
          homeTeamId: 35084,
          awayTeam: ACTIVE_CLUB.name,
          awayTeamId: ACTIVE_CLUB.id,
          scoreDisplay: "Ida: 10/09 • Volta: 17/09",
          date: "10/09/2026",
          status: "notstarted",
        },
        {
          ...
          awayTeamId: 1983,
          scoreDisplay: "Ida: 17/09 • Volta: 24/09",
          date: "17/09/2026",
          status: "notstarted",
        },
        {
          ...
          awayTeam: "São Paulo",
          awayTeamId: 1981,
          scoreDisplay: "Ida: 18/09 • Volta: 25/09",
          date: "18/09/2026",
          status: "notstarted",
        },
        {
          ...
          awayTeamId: 1975,
          scoreDisplay: "Ida: 19/09 • Volta: 26/09",
          date: "19/09/2026",
          status: "notstarted",
        },
      ],
      ...
      matches: [
        {
          ...
          scoreDisplay: "Decisão Libertadores 2026",
          status: "notstarted",
        },
      ],
    },
...
export const DEFAULT_CDB_BRACKET: TournamentBracket = {
  rounds: [
    {
      name: "Oitavas de Final",
      matches: [
      ...
      matches: [
        {
          ...
          homeTeam: "Finalista 1",
          awayTeam: "Finalista 2",
          scoreDisplay: "Decisão Copa do Brasil 2026",
          status: "notstarted",
        },
      ],
    },
...
export const DEFAULT_CHAMPIONSHIPS: Championship[] = [
  ...
  },
  {
    ...
    bracket: DEFAULT_LIBERTADORES_BRACKET,
    knockout: {
      opponent: "Independiente del Valle",
      opponentId: 35084,
